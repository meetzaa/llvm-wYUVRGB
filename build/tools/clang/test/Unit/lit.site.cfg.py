# Autogenerated from /mnt/s/WIP/llvm-project/clang/test/Unit/lit.site.cfg.py.in
# Do not edit!
...
lit_config.load_config(
    config, os.path.join(path(r"/mnt/s/WIP/llvm-project/clang"), "test/Unit/lit.cfg.py"))
